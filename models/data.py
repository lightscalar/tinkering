...
def find_counts(state, scope, models):
    ...
    for itr,model in enumerate(scope):
        ...
        # Now let's accumulate the matches.
...
class Data(Model):
    ...
    def __init__(self, data, nb_bins=25):
    ...
    def _update_factor(self): 
        ...
        if len(self.dependencies) == 0:
            ...
            # Cycle through observed data. Adding 1 to counts as a Dirichlet 
            # prior.
            ...
            print 'Adjusting factor because we now have a dependency.'
            scope = self.scope
